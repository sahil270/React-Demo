const quotes = [
  ...
  "Whether you’re looking for the best quotes about life to share with a friend or inspirational quotes to post online, a great quote can offer hope. Discover the most famous, motivating quotes in this post.",
  "My favorite quotes contain messages that provide wisdom. I can carry these messages with me every day and find inspiration to be the best version of myself. You’ll notice below that I’ve gathered bits of knowledge from activists, leaders, and authors.",
  ...
  "Whether you're stuck in a creative rut or feeling down after a professional setback, these words can help give you the boost you need to move forward.",
  ...
  "Life is trying things to see if they work. - Ray Bradbury",
  "Many of life's failures are people who did not realize how close they were to success when they gave up. - Thomas A. Edison",
  "Who likes failure? When I make mistakes or don’t actualize my plans, I feel the sting. However, everyone experiences failure at some point in their life — even the most successful people. When I fail, I remind myself that great leaders learn from these setbacks. They never give up and push forward instead.",
  ...
  "Beyond that, I’ve found that these quotes are so famous that they then tend to pop up in daily life. I’ve found myself nodding along and feeling assured when I know the person who said the words first. If you’re looking to know where a truism came from, you can check them out below.",
  ...
  "When I’m having trouble finding motivation, reading the words of other people can gives me the boost I need. If you found this list of famous quotes insightful, you'll love these posts too:",
  "Whether you're pursuing success as an entrepreneur, in sales, or in everyday life, the experiences and lessons of others are valuable resources. Those who keep learning and growing often find success. Where will your next success lie?",
